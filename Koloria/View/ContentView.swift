        ...
        VStack {
            ...
            ScrollView(.horizontal) {
                HStack(spacing: 10) {
                    ...
                    Button("PyrUP") {
                        viewModel.image = OpenCVWrapper.pyrUp(viewModel.image)
                    }.buttonStyle(BorderlessButtonStyle())
                        .padding(.horizontal, 20)
                        .padding(.vertical, 7)
                        .foregroundColor(.white)
                    ...
                    Button("Dilate") {
                        viewModel.image = OpenCVWrapper.dilate(viewModel.image)
                    }.buttonStyle(BorderlessButtonStyle())
                        .padding(.horizontal, 20)
                        .padding(.vertical, 7)
                        .foregroundColor(.white)
                    ...
                    Button("Erode") {
                        viewModel.image = OpenCVWrapper.erode(viewModel.image)
                    }.buttonStyle(BorderlessButtonStyle())
                        .padding(.horizontal, 20)
                        .padding(.vertical, 7)
                        .foregroundColor(.white)
